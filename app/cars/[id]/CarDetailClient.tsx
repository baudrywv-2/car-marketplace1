...
export type CarDetailInitial = Car;

type Props = {
  initialCar?: Car | null;
};

export default function CarDetailClient({ initialCar = null }: Props) {
  ...
  useEffect(() => {
    async function load() {
      let carData = !isPreview && initialCar && initialCar.id === id ? initialCar : null;
